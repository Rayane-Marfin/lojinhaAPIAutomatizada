...
public class ProdutoTest {
    ...
    @Test
    @DisplayName("Validar que o valor do produto igual a O.00 não é permitido")
    public void testValidarLimiteZeradoProibidoValorProduto(){
        // Tentar inserir um produto com valo 0.00 e validar que a mensagem de erro foi apresentada
    ...
    public void testValidarLimiteMaiorSeteMilProibidoValorProduto(){
        // Tentar inserir um produto com valo 7000.01 e validar que a mensagem de erro foi apresentada
        // E o status code retornado foi 422
